...
export default function HomePage() {
  ...
  return (
    < >
      ...
      <div className={` ${isThemeChanged ? 'bg-gray-900' : 'bg-gray-300'} ${width > 500 ? 'w-12/12' : 'w-[100%]'}  ${width > 500 ? '' : 'bottom-[110px]'} relative bg-no-repeat bg-cover scroll-smooth  ${InfoWindowCounter > 0 ? ' bottom-[20px] h-[1250px] ' : ''} `}>
