...
<div className={` z-30 sticky top-[56px] w-12/12  bg-cyan-700   text-2xl text-zinc-200 flex flex-row flex-wrap justify-center items-center ${InfoWindowCounter > 0 ? 'hidden' : 'block'} `}>
            <button className={` z-10 bg-transparent mx-2 my-1 ${TVrefCur > 450 ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold ml-10 hover:text-red-600`} ><Link to="Smartphones" smooth={true} spy={true} duration={3000}><div className=" h-8 ">Smartphones</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(TVrefCur <= 450) && (CleanersRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600 scroll-smooth `}  ><Link to="TV&Laptops" smooth={true} spy={true} duration={3000}><div className=" h-8 ">TV's & Laptops</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(CleanersRefCur <= 450) && (WatchesRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''}  my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600`} href={CleanersRef}><Link to="Cleaners" smooth={true} duration={3000}><div className=" h-8 ">Cleaners</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(WatchesRefCur <= 450) && (FridgesRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600`} href={WatchesRef} ><Link to="Smart-watches" smooth={true} duration={3000}><div className=" h-8 ">Smart watches</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(FridgesRefCur <= 450) && (KettlesRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600`} href={FridgesRef}><Link to="Fridges" smooth={true} duration={3000}><div className=" h-8 ">Fridges</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(KettlesRefCur <= 450) && (WashMachinesRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600`} href={KettlesRef}><Link to="Kettles" smooth={true} duration={3000}><div className=" h-8 ">Kettles</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(WashMachinesRefCur <=450) && (HeadphonesRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600`} href={WashMachinesRef}><Link to="Washing-machines" smooth={true} duration={3000}><div className=" h-8 ">Washing machines</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(HeadphonesRefCur <= 450) && (MicrowavesRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600`} href={HeadphonesRef}><Link to="Headphones" smooth={true} duration={3000}><div className=" h-8 ">Headphones</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${ (MicrowavesRefCur <= 450) && (DryersRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600`} href={MicrowavesRef}><Link to="Microwaves" smooth={true} duration={3000}><div className=" h-8 ">Microwaves</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(DryersRefCur <= 450) && (BlendersRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600`} href={DryersRef}><Link to="Dryers" smooth={true} duration={3000}><div className=" h-8 ">Dryers</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(BlendersRefCur <= 450) && (OtherRefCur > 450) ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600`} href={BlendersRef}><Link to="Blenders" smooth={true} duration={3000}><div className=" h-8 ">Blenders</div></Link></button>
            <button className={`z-10 bg-transparent mx-2 my-1 ${(OtherRefCur <= 450)  ?  'text-red-600  border-b-[3px] border-red-600 ' : ''} my-3 ${ width > 600 ? "text-2xl" : "text-xl"} font-serif font-semibold hover:text-red-600 `} href={OtherRef}><Link to="Other" smooth={true} duration={3000}><div className=" h-8 ">Other</div></Link></button> 
        </div>
