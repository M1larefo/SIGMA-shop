  ...
  return (
    <>
      < div className='h-full min-h-[1000px]'>
        ...
        <div className={`${isThemeChanged ? 'bg-gray-900' : 'bg-gray-300'} w-12/12 bg-no-repeat bg-cover scroll-smooth relative h-full ${width <= 500 ? "w-[120%] "  : "" } ${InfoWindowCounter > 0 ? 'min-h-[1150px]' : 'min-h-[1000px]'}  `}>
